...
export const metadata: Metadata = {
    ...
    description: 'Keidi Teixeira. Desenvolvedora Full Stack.',
};
...
export default function AreasConhecimento() {
    const router = useRouter(); // Importing useRouter here

    if (typeof window !== 'undefined') { // Checking if window is available (client-side)
        const { useSearchParams } = require('next/navigation'); // Importing useSearchParams only on the client-side
    }
